...
\chapter{Background}
	...
	\section{Fairness Concepts in Machine Learning}\label{sec:fairness_concepts}
		\input{sections/background/2.1-fairness-in-ml.tex}

	\section{Preliminaries and Fairness in Clustering}\label{sec:fair_clustering}
		\input{sections/background/2.2-fair-clustering.tex}

	\section{Hierarchical Clustering and Cost}
		\input{sections/background/2.3-hierarchical-clustering-and-cost.tex}
	
	\section{Fair Hierarchical Clustering}\label{subsec:fair_hierarchical_clustering}
		\input{sections/background/2.4-fair-hierarchical-clustering.tex}
