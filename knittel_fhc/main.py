...
def main():
    ...
    parser = argparse.ArgumentParser(description='Run fair hierarchical clustering experiments')
    parser.add_argument('--output_dir', type=str, default='results',
                        help='Directory to save results')
    parser.add_argument('--test', action='store_true',
                        help='Run a minimal test experiment')
    ...
    if args.test:
        ...
        sizes = [64, 128, 256, 512, 2**10, 2**11, 2**12, 2**13, 2**14]
